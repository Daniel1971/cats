...
/*
    ...
    */
    ...
    var list = [
    document.getElementById("bild49").innerHTML, document.getElementById("bild50").innerHTML,
    document.getElementById("bild51").innerHTML, document.getElementById("bild52").innerHTML,
    document.getElementById("bild53").innerHTML, document.getElementById("bild54").innerHTML,
    document.getElementById("bild55").innerHTML];
